...
class FactFinderConnector
{
    ...
    /**
     * @var \SprykerEco\Client\FactFinderApi\FactFinderApiConfig
     */
    ...
    /**
     * @param \SprykerEco\Client\FactFinderApi\FactFinderApiConfig $factFinderConfig
     */
    public function __construct(FactFinderApiConfig $factFinderConfig)
    {
    ...
    /**
     * @param \Generated\Shared\Transfer\FactFinderApiSearchRequestTransfer $searchRequestTransfer
     *
     * @return \FACTFinder\Util\Parameters
     */
    public function createRequestParametersFromSearchRequestTransfer(FactFinderApiSearchRequestTransfer $searchRequestTransfer)
    {
