...
use Generated\Shared\Transfer\FactFinderApiDataFilterGroupTransfer;
use Generated\Shared\Transfer\FactFinderApiDataFilterTransfer;
...
class FilterGroupConverter extends BaseConverter
{
    ...
    /**
     * @return \Generated\Shared\Transfer\FactFinderApiDataFilterGroupTransfer
     */
    public function convert()
    {
        $factFinderDataFilterGroupTransfer = new FactFinderApiDataFilterGroupTransfer();
     ...
     *
     * @return \Generated\Shared\Transfer\FactFinderApiDataFilterTransfer
     */
    protected function convertFilter(Filter $filter)
    {
        $factFinderDataFilterTransfer = new FactFinderApiDataFilterTransfer();
