...
class SearchRequestTest extends PHPUnit_Framework_TestCase
{
    ...
    /**
     * @return \SprykerEco\Client\FactFinderSdk\Business\Api\Handler\Request\SearchRequest
     */
    protected function createSearchRequest(): SearchRequest
    {
     ...
     */
    protected function createFactfinderResult(): Result
    {
        return new Result([
            new Record(
                '111_28549472',
     ...
     */
    protected function createExpectedTransfer(): FactFinderSdkSearchResponseTransfer
    {
        $searchResponseTransfer = new FactFinderSdkSearchResponseTransfer();
     ...
     */
    protected function getResultPerPageTransfer(): FactFinderSdkDataResultsPerPageOptionsTransfer
    {
        $defaultOption = new FactFinderSdkDataItemTransfer();
        ...
        $resultPerPage = new FactFinderSdkDataResultsPerPageOptionsTransfer();
     ...
     */
    protected function getPagingTransfer(): FactFinderSdkDataPagingTransfer
    {
        $paging = new FactFinderSdkDataPagingTransfer();
        $paging->setPageCount(1);

        $emptyPageItem = new FactFinderSdkDataPageTransfer();
        ...
        $item = new FactFinderSdkDataItemTransfer();
        $item->setUrl('#');
        $item->setLabel(1);
        $item->setSelected(true);

        $currentPage = new FactFinderSdkDataPageTransfer();
     ...
     * @return \ArrayObject
     */
    protected function getBreadCrumbsArray(): ArrayObject
    {
        $item = new FactFinderSdkDataItemTransfer();
        ...
        $breadCrumb = new FactFinderSdkDataBreadCrumbTransfer();
     ...
     */
    protected function getAfterSearchNavigationTransfer(): FactFinderSdkDataAfterSearchNavigationTransfer
    {
        $afterSearchNavigation = new FactFinderSdkDataAfterSearchNavigationTransfer();
     ...
     */
    protected function getCampaignIteratorTransfer(): FactFinderSdkDataCampaignIteratorTransfer
    {
     ...
     * @return \ArrayObject
     */
    protected function getSortingItemsArray(): ArrayObject
    {
        $labels = [
        ...
        foreach ($labels as $label) {
            $sortingItem = new FactFinderSdkDataItemTransfer();
            $sortingItem->setUrl(' ');
     ...
     */
    protected function getResultTransfer(): FactFinderSdkDataResultTransfer
    {
        $dataRecord = new FactFinderSdkDataRecordTransfer();
