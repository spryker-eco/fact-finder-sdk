...
class RecommendationResponseConverterTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testConvertShouldReturnCorrectData(): void
    {
        ...
        $expectedRecommendation = $this->getExpectedTransferObject()->getRecommendations();
     ...
     */
    protected function getExpectedTransferObject(): FactFinderSdkRecommendationResponseTransfer
    {
