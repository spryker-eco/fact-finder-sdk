...
class ProductCampaignResponseConverterTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testConvertShouldReturnCorrectData(): void
    {
        ...
        $result = $productCampaignResponseConverter->convert()->toArray();
    ...
    /**
     * @return \PHPUnit\Framework\MockObject\MockObject|\FACTFinder\Adapter\ProductCampaign
     */
    protected function createProductCampaignAdapterMock(): ProductCampaign
    {
     ...
     */
    protected function getCampaigns(): CampaignIterator
    {
        $pushedProducts = [
            new Record(
                '111_28549472',
     ...
     */
    protected function createProductCampaignResponseConverter(
        ProductCampaign $productCampaignAdapter,
        ConverterFactory $converterFactory
    ): ProductCampaignResponseConverter {
     ...
     */
    protected function createExpectedTransfer(): FactFinderSdkProductCampaignResponseTransfer
    {
        $searchResponseTransfer = new FactFinderSdkProductCampaignResponseTransfer();

        return $searchResponseTransfer->setCampaignIterator($this->getCampaignIteratorTransfer());
    }
